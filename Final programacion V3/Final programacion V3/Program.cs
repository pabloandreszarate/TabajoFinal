namespace Final_programacion_V3
{
    internal class Program
    {
        public string[,] vehiculos = new string[0,5];
        public string[,] clientes = new string[0,3];
        public string[,] arreglos = new string[0,3];
        ...
        static void GestionVehiculos()
        {
            ...
            static void RegistrarVehiculo()
            {
                ...
                Vehiculos[0,1] = Console.ReadLine();    
