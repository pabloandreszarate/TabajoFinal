namespace Final_programacion_V10
{
    internal class Program
    {
        ...
        static void GestionVehiculos()
        {
            ...
            static void ListaVehiculos()
            {
                ...
                {
                    Console.WriteLine($"{i + 1}, Placa:{vehiculos[i, 0]} | Marca:{vehiculos[i, 1]} | Modelo:{vehiculos[i, 2]} | Año:{vehiculos[i, 3]} | Esta a nombre de:{vehiculos[i, 4]}");
                }
                Console.ReadKey();
            }
        }
        ...
        {
            Console.WriteLine("ingrese la placa del vehiculo que desea asignar:");
            string placa = Console.ReadLine();
